...
contract SimpleBank {
    ...
    function getBalance() public isEnrolled(msg.sender) view returns (uint) {
    ...
    function enroll() public notEnrolled(msg.sender) returns (bool){
    ...
    function withdraw(uint withdrawAmount) public isEnrolled(msg.sender) returns (uint) {
      ...
      require(balances[msg.sender]>= withdrawAmount, "You do not have sufficient funds");
